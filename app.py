...
# ==========================================
st.set_page_config(
    page_title="2026 全國賞櫻地圖 (蘇佐璽嚴選 Pro)",
    page_icon="🌸",
    layout="centered",
...
all_spots_db = [
    ...
    {"name": "陽明山平菁街", "region": "北部", "county": "台北", "lat": 25.135, "lon": 121.560, "zone": "郊區", "month": [1, 2], "flower": "寒櫻", "status": "🍃 謝花", "desc": "台北第一波櫻花。"},
...
if run_btn:
    ...
    st.markdown("### 🔥 本週熱門賞櫻點")
    cols = st.columns(2)
    hot_spots = [s for s in all_spots_db if "滿開" in s['status']][:4]
